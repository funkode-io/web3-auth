...
object Dependencies {
  ...
  object Versions {
    ...
    val zioSchemaV = "0.4.0"

    val zioArangodbV = "0.1.0"
    val zioResourceV = "1.0.2"
  ...
  object Libraries {
    ...
    val zioSlf4j2Log = "dev.zio" %% "zio-logging-slf4j2" % zioLoggingV

    val zioArangodb = "io.funkode" %% "zio-arangodb-http" % zioArangodbV
    val zioResource = "io.funkode" %% "zio-resource"      % zioResourceV
